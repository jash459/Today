...
// Code for printing the edges for mst:
#include <bits/stdc++.h>
using namespace std;
...
{
public:
	// Function to find and print the edges of the Minimum Spanning Tree.
	void printMST(int V, vector<vector<int>> adj[])
	{
		...
		while (!pq.empty()) {
			...
			// If the parent is not -1, add the edge to the MST list
			if (parent != -1) {
