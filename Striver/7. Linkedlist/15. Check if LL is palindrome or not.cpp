...
// video : https://www.youtube.com/watch?v=lRY_G-u_8jk
...
bool isPalindrome(Node* head) {
    ...
    // we want the fast to stop 2nd last pointer, that's why fast->next->next != NULL for even and fast->next != NULL for odd
