...
// video : https://www.youtube.com/watch?v=bLGZhJlt4y0
...
// 2. Better :: writing an individual code for every direction is a lengthy process therefore we truncate the 4 “if statements” into a single for loop using the following approach.
